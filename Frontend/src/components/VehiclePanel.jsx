...
const VehiclePanel = (props) => {
  ...
  return (
    <div>
      ...
      <div className="flex border-2 mb-2 active:border-black bg-gray-50 rounded-xl p-3 w-full  items-center justify-between">
        <img
          className="h-16"
      ...
      <div className="flex border-2 mb-2 active:border-black bg-gray-50 rounded-xl p-3 w-full  items-center justify-between">
        ...
        <h2 className="text-lg font-semibold">₹110.57</h2>
      </div>
    </div>
  );
};
